...
class AvionCarga extends Avion {
    ...
    AvionCarga(this.capacidad_carga)

    String detalles_avion_carga() {
    return 'Vuelo: $codigoVuelo, Tipo: $tipoAvion, Capacidad: $capacidad_carga, Aerolínea: $aerolinea';
  }
}
...
void main() {
  ...
  AvionCarga avion_carga1 = AvionCarga("IB555", 50, "A444", "Iberia")
